...
def check_arguments():
    parser = argparse.ArgumentParser(description=f'Заполняет результаты игры в боулинг.')
    parser.add_argument("--result", help="Внесите данные пройденных фреймов."
                                         "Данные вносить слитно. Используются числа от 1 до 9"
                                         " и `X`,`/` и `-`")
